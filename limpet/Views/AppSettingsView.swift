...
struct AppSettingsView: View {
    ...
    @State private var debugLogging = LimpetSettings.debugLoggingEnabled
    ...
    private var launchAtLoginToggle: some View {
        Toggle(isOn: Binding(
            ...
            VStack(alignment: .leading, spacing: 2) {
                ...
                Text("Automatically start limpet when you log in")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
        }
    ...
    private var debugLoggingToggle: some View {
        ...
        .onChange(of: debugLogging) { newValue in
            LimpetSettings.debugLoggingEnabled = newValue
            ...
            VStack(alignment: .leading, spacing: 12) {
                HStack(alignment: .top, spacing: 12) {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        Text("Join the limpet community on Discord")
                            .font(.body)
    ...
    private var aboutSection: some View {
        GroupBox("About") {
            VStack(alignment: .leading, spacing: 8) {
                ...
                infoRow("Config", value: "~/.config/limpet/")
